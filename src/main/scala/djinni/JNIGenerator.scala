...
class JNIGenerator(spec: Spec) extends Generator(spec) {
  ...
  class JNIRefs(name: String, cppPrefixOverride: Option[String] = None) {
    ...
    spec.cppNnHeader match {
      case Some(nnHdr) => jniHpp.add("#include " + q(nnHdr))
      case _           =>
    }
  ...
  override def generateEnum(origin: String, ident: Ident, doc: Doc, e: Enum) {
    ...
    writeJniHppFile(
      ident,
      origin,
      Iterable.concat(refs.jniHpp, refs.jniCpp),
      Nil,
      w => {
        ...
        w.w(s"class $jniHelper final : ::djinni::$base").bracedSemi {
          ...
          if (e.flags) {
            w.wl(
              s"static CppType toCpp(JNIEnv* jniEnv, JniType j) { return static_cast<CppType>(::djinni::JniClass<$jniHelper>::get().flags(jniEnv, j)); }"
            )
            w.wl(
              s"static ::djinni::LocalRef<JniType> fromCpp(JNIEnv* jniEnv, CppType c) { return ::djinni::JniClass<$jniHelper>::get().create(jniEnv, static_cast<unsigned>(c), $count); }"
            )
          } else {
            w.wl(
              s"static CppType toCpp(JNIEnv* jniEnv, JniType j) { return static_cast<CppType>(::djinni::JniClass<$jniHelper>::get().ordinal(jniEnv, j)); }"
            )
            w.wl(
              s"static ::djinni::LocalRef<JniType> fromCpp(JNIEnv* jniEnv, CppType c) { return ::djinni::JniClass<$jniHelper>::get().create(jniEnv, static_cast<jint>(c)); }"
            )
          }
          w.wl
          w.wlOutdent("private:")
  ...
  override def generateRecord(
    ...
    def writeJniPrototype(w: IndentWriter) {
      ...
      w.w(s"class $jniHelper final").bracedSemi {
        ...
        w.wl(
          s"static ::djinni::LocalRef<JniType> fromCpp(JNIEnv* jniEnv, const CppType& c);"
        )
        w.wl
        w.wlOutdent("private:")
        w.wl(s"$jniHelper();")
        ...
        w.wl(
          s"const ::djinni::GlobalRef<jclass> clazz { ::djinni::jniFindClass($classLookup) };"
        )
        val constructorSig = q(jniMarshal.javaMethodSignature(r.fields, None))
        w.wl(
          s"const jmethodID jconstructor { ::djinni::jniGetMethodID(clazz.get(), ${q("<init>")}, $constructorSig) };"
        )
        for (f <- r.fields) {
          val javaFieldName = idJava.field(f.ident)
          val javaSig = q(jniMarshal.fqTypename(f.ty))
          w.wl(
            s"const jfieldID field_$javaFieldName { ::djinni::jniGetFieldID(clazz.get(), ${q(javaFieldName)}, $javaSig) };"
          )
        }
      }
    }
    ...
    def writeJniBody(w: IndentWriter) {
      ...
      writeJniTypeParams(w, params)
      w.w(
        s"auto $jniHelperWithParams::toCpp(JNIEnv* jniEnv, JniType j) -> CppType"
      ).braced {
        ...
        writeAlignedCall(
          ...
          f => {
            ...
            val jniFieldAccess = toJniCall(
              f.ty,
              (jt: String) => s"jniEnv->Get${jt}Field(j, $fieldId)"
            )
    ...
    def writeJniPrototype(w: IndentWriter) {
      ...
      w.w(s"class $jniSelf final : $baseType").bracedSemi {
        ...
        if (spec.cppNnType.nonEmpty) {
          ...
          w.wl(
            s"static CppType toCpp(JNIEnv* jniEnv, JniType j) { return ::djinni::JniClass<$jniSelf>::get()._fromJava(jniEnv, j); }"
          )
        }
        w.wl(
          s"static ::djinni::LocalRef<JniType> fromCppOpt(JNIEnv* jniEnv, const CppOptType& c) { return {jniEnv, ::djinni::JniClass<$jniSelf>::get()._toJava(jniEnv, c)}; }"
        )
        w.wl(
          s"static ::djinni::LocalRef<JniType> fromCpp(JNIEnv* jniEnv, const CppType& c) { return fromCppOpt(jniEnv, c); }"
        )
        w.wl
        w.wlOutdent("private:")
        w.wl(s"$jniSelf();")
        ...
        if (i.ext.java) {
          w.wl(
            ...
            w.wl(
              s"friend ::djinni::JniInterface<$cppSelf, ${withNs(Some(spec.jniNamespace), jniSelf)}>;"
            )
          }
          w.wl
          w.wl(
            s"const ::djinni::GlobalRef<jclass> clazz { ::djinni::jniFindClass(${q(classLookup)}) };"
          )
          for (m <- i.methods) {
            val javaMethodName = idJava.method(m.ident)
            val javaMethodSig =
              q(jniMarshal.javaMethodSignature(m.params, m.ret))
            w.wl(
              s"const jmethodID method_$javaMethodName { ::djinni::jniGetMethodID(clazz.get(), ${q(javaMethodName)}, $javaMethodSig) };"
            )
          }
        }
      }
    ...
    def writeJniBody(w: IndentWriter) {
      ...
      if (i.ext.java) {
        ...
        for (m <- i.methods) {
          ...
          writeJniTypeParams(w, typeParams)
          val methodNameAndSignature: String =
          ...
          w.w(s"$ret $jniSelfWithParams::JavaProxy::$methodNameAndSignature")
            .braced {
              ...
              w.wl(
                s"const auto& data = ::djinni::JniClass<${withNs(Some(spec.jniNamespace), jniSelf)}>::get();"
              )
              val call = m.ret.fold("jniEnv->CallVoidMethod(")(r =>
                "auto jret = " + toJniCall(
                  r,
                  (jt: String) => s"jniEnv->Call${jt}Method("
                )
              )
              w.w(call)
              ...
              m.ret.fold()(ty => {
                (spec.cppNnCheckExpression, isInterface(ty.resolved)) match {
                  case (Some(check), true) => {
                    ...
                    val javaParamsString: String =
                      javaParams.mkString("(", ",", ")")
                    val functionString: String =
                      s"${javaMarshal.fqTypename(ident, i)}#$javaMethodName$javaParamsString"
                    w.wl(
                      s"""DJINNI_ASSERT_MSG(jret, jniEnv, "Got unexpected null return value from function $functionString");"""
                    )
      ...
      if (i.ext.cpp) {
        ...
        def nativeHook(
          ...
          val paramList = params
            .map(p =>
              jniMarshal.paramType(p.ty) + " j_" + idJava.local(p.ident)
            )
            .mkString(", ")
          ...
          if (static) {
            ...
            w.wl(
              s"CJNIEXPORT $jniRetType JNICALL ${prefix}_00024CppProxy_$methodNameMunged(JNIEnv* jniEnv, jobject /*this*/, jlong nativeRef${preComma(paramList)})"
            ).braced {
              w.w("try")
                .bracedEnd(s" JNI_TRANSLATE_EXCEPTIONS_RETURN(jniEnv, $zero)") {
                  spec.jniPrologueHeader.foreach(x=>w.wl(s"""DJINNI_FUNCTION_PROLOGUE("${ident.name}.${name}");"""))
        ...
        nativeHook(
          ...
          None, {
            w.wl(
              s"delete reinterpret_cast<::djinni::CppProxyHandle<$cppSelf>*>(nativeRef);"
            )
          }
        )
        for (m <- i.methods) {
          ...
          nativeHook(
            nativeAddon + idJava.method(m.ident),
            m.static,
            m.params,
            m.ret, {
              //w.wl(s"::${spec.jniNamespace}::JniLocalScope jscope(jniEnv, 10);")
              ...
              m.params.foreach(p => {
                if (
                  ...
                  val javaMethodName = idJava.method(m.ident)
                  val javaParams = m.params.map(p =>
                    javaMarshal.fqParamType(p.ty) + " " + idJava.local(p.ident)
                  )
                  val javaParamsString: String =
                    javaParams.mkString("(", ", ", ")")
                  val functionString: String =
                    s"${javaMarshal.fqTypename(ident, i)}#$javaMethodName$javaParamsString"
                  w.wl(
                    s"""DJINNI_ASSERT_MSG(j_$paramName, jniEnv, "Got unexpected null parameter '$paramName' to function $functionString");"""
                  )
                }
              })
  ...
  def writeJniTypeParams(w: IndentWriter, params: Seq[TypeParam]) {
    ...
    w.wl(
      "template " + params
        .map(p => "typename " + spec.jniClassIdentStyle(p.ident))
        .mkString("<", ", ", ">")
    )
  }
  ...
  def toJniCall(ty: TypeRef, f: String => String): String =
    toJniCall(ty.resolved, f, false)
  def toJniCall(m: MExpr, f: String => String, needRef: Boolean): String =
    m.base match {
      case p: MPrimitive =>
        f(if (needRef) "Object" else IdentStyle.camelUpper(p.jName))
